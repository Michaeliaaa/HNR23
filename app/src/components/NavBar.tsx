        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#book" className={activeLink === 'read' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('books')}>E-book</Nav.Link>
            </Nav>
            <span className="navbar-text">
              <HashLink to='#book'>
                <button className="vvd"><span>Start Solving!</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
